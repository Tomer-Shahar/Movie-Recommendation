...
class recommenderGui:
    ...
    def showMainWindow(self):
        ...
        # self.mainWindoww.setStyleSheet(„ background-image: url(backgound.png);“)
            ...
            try:
                ...
                if rank_number < 0 or rank_number > 5:
                    if i == 19:
                        ...
                        message_box.about(self.visitorWindow, "Wrong input",
                                          "Please ensure you've rated at least 5 movies and that you've entered a "
                ...
                if i == 19:
                    if number_of_rated_movies < 5:
                        message_box = QMessageBox()
                        message_box.about(self.visitorWindow, "Wrong input",
                                          "Please ensure you've rated at least 5 movies and that you've entered a number between 0 and 5.")
                        message_box.close()
                        self.visitorWindow.show()
                        break
        if success:
